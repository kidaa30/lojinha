...
abstract class DJUploadHelper {
	...
	public static function getUploader($id = 'uploader', $settings = array()) {
		...
		$html = '<div id="'.$id.'"><p>Unfortunately images multiupload was unable to start, there are probably some script errors on site. Please contact us using helpdesk at dj-extensions.com.</p></div>';
	...
	public static function upload() {
		...
		if (!$chunks || $chunk == $chunks - 1) {
			...
			if(strstr('.jpg', $filePath) || strstr('.png', $filePath) || strstr('.gif', $filePath)){ 
