...
function backup_error(message)
{
	(function($){
        ...
        resumeNotificationMessage.replace('%d', akeeba_autoresume_timeout.toFixed(0))
        akeebaBackup_notifications_notify(akeeba_translations['UI-BACKUPHALT'], resumeNotificationMessage);
		reset_retry_timeout();
